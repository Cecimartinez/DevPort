  ...
  return (
    ...
    <div id="profesionales" className="flex flex-col px-20 py-10 items-center h-screen w-screen">
      ...
      <div className="flex flex-col md:flex-row w-full justify-center m-7 h-auto">
        <ProfesionalCard fullname="Cecilia Martinez" role="Software Developer" src="../../img/cecicash.png" label={"..."} to={"/professionalprofile/cecilia-martinez/aboutme"}  />
        <ProfesionalCard fullname="Fernando Longin" role="Software Developer" src="../../img/ferbigmoji.png" label={"..."} to={"/professionalprofile/fernando-longin/aboutme"} >
        </ProfesionalCard>
      </div>
    </div>
  );
