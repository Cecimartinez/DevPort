...
export const Profesionales = () => {
  return (
    <div id="profesionales" className="flex flex-col px-4 sm:px-10 mb-20 pb-24 md:px-20 py-10 items-center h-screen overflow-x-hidden ]">
      <Subtitulo value="Professionals" className="font-extrabold text-3xl text-white sm:text-4xl py-4 mx-auto title-professionals" />
      <p className="py-5 text-center text-lg font-bold text-white">Explore the portfolios of our professionals.</p>
